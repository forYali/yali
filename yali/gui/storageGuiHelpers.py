...
class PartitionItem(QtWidgets.QListWidgetItem):
...
class PhysicalVolumeListItem(QtWidgets.QListWidgetItem):
    def __init__(self, parent, widget):
        QtWidgets.QListWidgetItem.__init__(self, parent)
        self.widget = widget
        self.setSizeHint(QSize(40, 40))

class PhysicalVolumeItem(QtWidgets.QWidget):
    def __init__(self, parent, text, device, editor, widget):
        QtWidgets.QListWidgetItem.__init__(self, parent)
        self.layout = QtWidgets.QHBoxLayout(self)
        self.checkBox = QtWidgets.QCheckBox(self)
        self.layout.addWidget(self.checkBox)
        self.labelDrive = QtWidgets.QLabel(self)
