...
class VolumeGroupWidget(QWidget, Ui_VolumeGroupWidget):
    def __init__(self, parent, request, isNew):
        ...
        self.physicalExtends.currentIndexChanged[int].connect(self.physicalExtendsChanged)
        ...
        self.logicalVolumesTree.itemClicked[QTreeWidgetItem, int].connect(self.activateButtons)
